...
actual object BackgroundSyncManager {
    ...
    actual fun schedulePeriodicSync(intervalMinutes: Int) {
        ...
        val syncRequest = PeriodicWorkRequestBuilder<BackboneSyncWorker>(
        ...
        WorkManager.getInstance(context).enqueueUniquePeriodicWork(
            BackboneSyncWorker.SYNC_WORK_NAME,
    ...
    actual fun cancelPeriodicSync() {
        ...
        val context = contextRef?.get()
        if (context != null) {
            WorkManager.getInstance(context).cancelUniqueWork(BackboneSyncWorker.SYNC_WORK_NAME)
        }
    ...
    actual fun requestImmediateSync() {
        ...
        val immediateRequest = OneTimeWorkRequestBuilder<BackboneSyncWorker>()
            .setConstraints(constraints)
            .setInputData(Data.Builder().putString("trigger_type", "on_connect").build())
            .addTag(BackboneSyncWorker.IMMEDIATE_SYNC_TAG)
            .build()
