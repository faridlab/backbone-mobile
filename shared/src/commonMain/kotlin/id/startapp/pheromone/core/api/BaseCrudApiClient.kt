package id.startapp.pheromone.core.api
import kotlin.concurrent.Volatile

import id.startapp.pheromone.domain.types.Result
import id.startapp.pheromone.infrastructure.network.CertificatePinningManager
import id.startapp.pheromone.infrastructure.network.RequestSigner
import id.startapp.pheromone.infrastructure.network.RetryConfig
import id.startapp.pheromone.infrastructure.network.apiCall
import id.startapp.pheromone.infrastructure.network.calculateBackoff
import id.startapp.pheromone.infrastructure.network.isRetryable
import id.startapp.pheromone.infrastructure.network.signRequest
import id.startapp.pheromone.infrastructure.pagination.BackendPaginatedResponse
...
//       override val basePath = "$baseUrl/api/v1/pheromone/orders"
...
abstract class BaseCrudApiClient<E>(
    ...
    //
    // Example:
    //   override val pinnedHosts = setOf("api.pheromone.com")
