    ...
    Column(modifier = modifier) {
        ...
        Row(
            ...
            OutlinedButton(
                ...
                border = androidx.compose.foundation.BorderStroke(
                    1.dp, if (startError != null) id.startapp.pheromone.presentation.ui.theme.ErrorRed else PheromoneBlue
                )
            ) {
                Icon(
                    imageVector = Icons.Rounded.CalendarMonth,
                    contentDescription = "Select start date",
                    tint = if (startError != null) id.startapp.pheromone.presentation.ui.theme.ErrorRed else PheromoneBlue,
                    modifier = Modifier.width(18.dp).height(18.dp)
                )
                Spacer(modifier = Modifier.width(8.dp))
                Text(
                    text = dateRange.first?.let { formatDate(it) } ?: "Start",
                    color = if (startError != null) id.startapp.pheromone.presentation.ui.theme.ErrorRed else MaterialTheme.colorScheme.onSurface
                )
            }
            ...
            OutlinedButton(
                ...
                shape = RoundedCornerShape(4.dp),
                border = androidx.compose.foundation.BorderStroke(
                    1.dp, if (endError != null) id.startapp.pheromone.presentation.ui.theme.ErrorRed else PheromoneBlue
                )
            ) {
                Icon(
                    imageVector = Icons.Rounded.CalendarMonth,
                    contentDescription = "Select end date",
                    tint = if (endError != null) id.startapp.pheromone.presentation.ui.theme.ErrorRed else PheromoneBlue,
                    modifier = Modifier.width(18.dp).height(18.dp)
                )
                Spacer(modifier = Modifier.width(8.dp))
                Text(
                    text = dateRange.second?.let { formatDate(it) } ?: "End",
                    color = if (endError != null) id.startapp.pheromone.presentation.ui.theme.ErrorRed else MaterialTheme.colorScheme.onSurface
                )
            }
        }
        ...
        if (dateRange.first != null && dateRange.second != null && dateRange.second!! < dateRange.first!!) {
            ...
            Text(
                ...
                color = id.startapp.pheromone.presentation.ui.theme.ErrorRed
            )
        }
    }
}
