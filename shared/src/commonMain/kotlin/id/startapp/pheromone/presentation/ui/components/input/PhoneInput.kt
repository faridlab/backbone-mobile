...
/**
 * Pheromone Phone Input Field
 *
 * Phone input with country code selector following Pheromone design system.
 *
 * Specs:
 * - Height: 56dp
...
fun PhoneInput(
    ...
    Row(
        ...
        Row(
            modifier = Modifier
                .width(100.dp)
                .height(PheromoneDimensions.InputHeight.dp)
        ...
        OutlinedTextField(
            ...
            colors = OutlinedTextFieldDefaults.colors(
                focusedBorderColor = if (error != null) ErrorRed else PheromoneBlue,
