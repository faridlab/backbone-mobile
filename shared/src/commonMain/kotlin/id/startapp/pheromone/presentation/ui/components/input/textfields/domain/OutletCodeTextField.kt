...
/**
 * Outlet Code Text Field
 *
 * Specialized text field for Pheromone outlet codes.
 *
 * Features:
 ...
 *
 * @param value Current outlet code value
 ...
 */
@Composable
fun OutletCodeTextField(
    value: String,
    modifier: Modifier = Modifier,
    externalLabel: String? = "Outlet Code",
    ...
    AppTextField(
        ...
        helperText = if (showCopiedFeedback) {
            ...
            "Auto-generated outlet identifier"
        }
    )
}
