...
fun SecondaryButton(
    ...
    OutlinedButton(
        ...
        colors = ButtonDefaults.outlinedButtonColors(
            ...
            contentColor = PheromoneBlue,
            disabledContainerColor = Color.Transparent,
            disabledContentColor = PheromoneBlue.copy(alpha = 0.38f)
        ),
        border = BorderStroke(
            width = 1.dp,
            color = if (enabled) PheromoneBlue else PheromoneBlue.copy(alpha = 0.12f)
        ),
