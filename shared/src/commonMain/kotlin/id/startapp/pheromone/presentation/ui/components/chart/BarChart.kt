...
import id.startapp.pheromone.presentation.ui.theme.PheromoneBlueLight
...
fun BarChart(
    ...
    barColor: Color = PheromoneBlue,
    barColorLight: Color = PheromoneBlueLight.copy(alpha = 0.4f),
    chartHeight: Int = 160,
