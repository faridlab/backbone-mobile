...
/**
 * Pheromone Bottom Sheet
 *
 * Modal bottom sheet following Pheromone design system.
 *
 * Specs:
    ...
    PheromoneBottomSheet(
        ...
        if (title != null) {
            Text(
                ...
                modifier = Modifier.padding(horizontal = PheromoneDimensions.LG.dp)
            )
        }
...
private fun BottomSheetActionItem(
    ...
    androidx.compose.foundation.layout.Row(
        modifier = modifier
            ...
            .padding(
                horizontal = PheromoneDimensions.LG.dp,
                vertical = PheromoneDimensions.MD.dp
            ),
...
fun ConfirmationBottomSheet(
    ...
    PheromoneBottomSheet(
        ...
        Column(
            modifier = Modifier
                .fillMaxWidth()
                .padding(PheromoneDimensions.LG.dp)
        ) {
            Text(
                text = title,
            ...
            androidx.compose.foundation.layout.Spacer(modifier = Modifier.height(PheromoneDimensions.SM.dp))
            ...
            androidx.compose.foundation.layout.Spacer(modifier = Modifier.height(PheromoneDimensions.LG.dp))

            // Buttons
            Row(
                modifier = Modifier.fillMaxWidth(),
                horizontalArrangement = Arrangement.spacedBy(PheromoneDimensions.MD.dp)
            ) {
                // Cancel button
                id.startapp.pheromone.presentation.ui.components.button.SecondaryButton(
                    text = "Cancel",
                    onClick = onDismiss,
                ...
                // Confirm button
                id.startapp.pheromone.presentation.ui.components.button.PrimaryButton(
                    text = confirmLabel,
                    onClick = {
                        onConfirm()
                        onDismiss()
