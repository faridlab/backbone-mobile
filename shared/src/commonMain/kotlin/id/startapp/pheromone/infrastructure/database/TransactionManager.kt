...
object TransactionManager {
    ...
    fun <T> transactionResult(
        ...
        return try {
            ...
            id.startapp.pheromone.domain.types.Result.Success(result)
        } catch (e: Exception) {
            id.startapp.pheromone.domain.types.Result.Error(mapException(e))
        }
    }
    ...
    ): id.startapp.pheromone.domain.types.Result<List<T>> {
