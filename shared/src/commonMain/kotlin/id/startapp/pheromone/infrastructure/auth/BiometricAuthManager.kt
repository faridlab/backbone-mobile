...
class OfflineAuthManager(
    ...
    private val secureStorage: id.startapp.pheromone.infrastructure.storage.SecureStorage,
    private val keyValueStorage: id.startapp.pheromone.infrastructure.storage.KeyValueStorage,
) {
    companion object {
