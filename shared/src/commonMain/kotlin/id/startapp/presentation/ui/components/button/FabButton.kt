...
fun FabButton(
    ...
    containerColor: Color = BackboneBlue
) {
...
fun FabButtonCustom(
    ...
    icon: ImageVector,
    contentDescription: String? = null,
    size: androidx.compose.ui.unit.Dp = BackboneDimensions.FabSize.dp,
    containerColor: Color = BackboneBlue
) {
    FloatingActionButton(
        onClick = onClick,
        ...
        Icon(
            ...
            contentDescription = contentDescription,
            tint = Color.White,
            modifier = Modifier.size(BackboneIconSizes.Medium.dp)
        )
    }
}

// Import icon sizes
private object BackboneIconSizes {
    const val Medium = 24
}
