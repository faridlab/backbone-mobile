...
fun StatCard(
    ...
    iconTint: Color = BackboneBlue.copy(alpha = 0.1f),
    iconColor: Color = BackboneBlue,
...
fun OrdersStatCard(
    ...
    StatCard(
        ...
        iconTint = BackboneBlue.copy(alpha = 0.1f),
        modifier = modifier,
        onClick = onClick,
        trend = trend,
...
fun TimerStatCard(
    ...
    StatCard(
        ...
        iconTint = if (isRunning) BackboneBlue.copy(alpha = 0.1f) else SurfaceGray300.copy(alpha = 0.3f),
        iconColor = if (isRunning) BackboneBlue else SurfaceGray300,
        modifier = modifier
    )
}
