...
/**
 * Backbone Loading Indicator
 *
 * Circular progress indicator following Backbone design system.
 *
 * Specs:
 * - Size: 48dp (default)
 * - Stroke: 4dp
...
fun LoadingIndicator(
    ...
    color: Color = BackboneBlue,
    strokeWidth: Dp = 4.dp
) {
    CircularProgressIndicator(
        modifier = modifier.size(BackboneDimensions.FabSize.dp),
        color = color,
